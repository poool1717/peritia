...
**Última actualización:** 27 julio 2026 (sesión 16 — Propuesta D: editor a 1180px con rail de navegación por bloques, tabla de valoración de Sec3 rediseñada de 15 a 11-12 columnas, fórmulas de cálculo visibles con ejemplos numéricos reales, Anexos con pestañas Facturas/Presupuestos separadas, y +2pt en toda la tipografía de la app)
...
- [ ] **Sesión 16 — pendiente de validar en producción por Pol:** el rail de navegación, la tabla de Sec3 rediseñada y la tipografía más grande — probados con Playwright y datos simulados (arnés de prueba descartado), no con un caso real todavía.
