...
**Última actualización:** 24 julio 2026 (sesión 14 — mejoras de usabilidad del editor pedidas por Pol: scroll al principio al cambiar de sección, barra lateral fija, cajas de texto que crecen con el contenido, fix del botón "Generar tabla" de Sec3, fix del auto-relleno de "Descripción de la Cobertura" en Sec4, emojis sustituidos por iconos de lucide-react)
...
- [ ] **Sesión 14 — pendiente de decisión de Pol:** aplicar (o no) el punto 5 del encargo — reorganizar los bloques de Sec3 y Sec4 en zonas "consultar / rellenar / calcular" (parámetros de garantía comprimidos en una tira de datos, botón de acción junto al modo que lo activa, perjudicados plegado, resultado separado). Presentadas dos maquetas; ninguna aplicada.
- [ ] **Sesión 14 — pendiente de validar en producción por Pol:** que la póliza rellene ya la "Descripción de la Cobertura" en Sec4 con un PDF real (el fix del límite de tokens no se pudo probar sin `ANTHROPIC_API_KEY` en local) y que "Generar tabla" produzca partidas con precio en un caso real.
