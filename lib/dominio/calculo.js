// lib/dominio/calculo.js
//
// Motor de cálculo de PERIT.IA, extraído de components/Peritia.jsx en el
// Sprint 4 (Foundation Refactor), Fase 0 — Safety Net.
//
// Extracción mínima y quirúrgica: solo funciones puras y sus datos de
// referencia directos (baremo de reparación, módulos de arquitectura,
// provincias). Ninguna lógica se ha modificado — el contenido de cada
// función es una copia exacta de la que había en Peritia.jsx.
//
// No incluye: estado, hooks, JSX, efectos, llamadas a IA, a Supabase ni a
// ninguna API. No incluye tampoco lógica de interfaz, meteorología ni
// interpretación de respuestas de IA — fuera del alcance de esta extracción,
// aunque también sean funciones puras (ver el informe de cierre de esta
// fase para la justificación de dónde se traza el límite).
